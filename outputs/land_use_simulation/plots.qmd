...
```{r}
area_by_department_land_use <- readRDS('~/../../capstone/pyforest/shinydata/simulation/bar_plot_datasets/area_by_department_land_use.rds')

area_by_district_land_use <- readRDS('~/../../capstone/pyforest/shinydata/simulation/bar_plot_datasets/area_by_district_land_use.rds')


area_pct_by_department_land_use <- readRDS('~/../../capstone/pyforest/shinydata/simulation/bar_plot_datasets/area_pct_by_department_land_use.rds')

area_pct_by_district_land_use <- readRDS('~/../../capstone/pyforest/shinydata/simulation/bar_plot_datasets/area_pct_by_district_land_use.rds')
```
